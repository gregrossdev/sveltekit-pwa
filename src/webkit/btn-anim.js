...
document.querySelectorAll('.wk-anim-btn').forEach((item) => {
...
const collect_data_from_element = (target) => {
	btn_anim_data.box_shadow_default = window
		.getComputedStyle(target)
		.getPropertyValue('--wk-bsw-default');
	btn_anim_data.box_shadow_after = window
		.getComputedStyle(target)
		.getPropertyValue('--wk-bsw-after');
	btn_anim_data.border_radius_default = window
		.getComputedStyle(target)
		.getPropertyValue('--wk-brd-radius-default');
	btn_anim_data.border_radius_after = window
		.getComputedStyle(target)
		.getPropertyValue('--wk-brd-radius-after');
};
